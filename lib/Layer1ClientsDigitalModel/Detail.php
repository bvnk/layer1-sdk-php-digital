...
class Detail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('document_link', $data ?? [], null);
    ...
    */
     ...
     * Sets document_link
     *
     * @param string|null $document_link document_link
     *
     * @return self
     */
    public function setDocumentLink($document_link)
    {
        if (is_null($document_link)) {
            throw new \InvalidArgumentException('non-nullable document_link cannot be null');
        }
