...
/**
 * CreateKeyPairRequest Class Doc Comment
 *
 * @category Class
 * @package  Layer1ClientsDigitalInvoker
 * @author   OpenAPI Generator team
 ...
 */
class CreateKeyPairRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets reference
     *
     * @param string|null $reference custom identifier supplied for key pair that is used to link key pair to specific customer or use case
     *
     * @return self
     */
     ...
     * Sets master
     *
     * @param bool|null $master whether this is a master key for the asset pool
     *
     * @return self
     */
