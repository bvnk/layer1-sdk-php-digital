...
/**
 * ScreeningMetadata Class Doc Comment
 *
 * @category Class
 * @package  Layer1ClientsDigitalInvoker
 * @author   OpenAPI Generator team
 ...
 */
class ScreeningMetadata implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ScreeningMetadata';
    ...
    */
     ...
     * Sets urls
     *
     * @param string[]|null $urls URLs to external screening providers relevant to the deposit
     *
     * @return self
     */
     ...
     * Sets ids
     *
     * @param string[]|null $ids Deposit screening identifiers within external screening providers
     *
     * @return self
     */
