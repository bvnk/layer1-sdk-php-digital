...
class Asset implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MODEL_UTXO = 'UTXO';
    public const MODEL_ACCOUNT = 'ACCOUNT';
    public const MODEL_CONTRACT = 'CONTRACT';
    public const MODEL_UNKNOWN_DEFAULT_OPEN_API = 'unknown_default_open_api';
    ...
    */
     ...
     *
     * @param int|null $decimal_precision currency decimal precision
     *
     * @return self
     */
     ...
     * Sets model
     *
     * @param string|null $model transaction model supported by the asset
     *
     * @return self
     */
    public function setModel($model)
    {
        ...
        if (!in_array($model, $allowedValues, true)) {
            $model = self::MODEL_UNKNOWN_DEFAULT_OPEN_API;
        }
