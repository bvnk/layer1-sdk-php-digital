...
class Balance implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets available
     *
     * @param mixed|null $available available
     *
     * @return self
     */
     ...
     * Sets reserved
     *
     * @param mixed|null $reserved reserved
     *
     * @return self
     */
     ...
     * Sets blockchain
     *
     * @param mixed|null $blockchain blockchain
     *
     * @return self
     */
    public function setBlockchain($blockchain)
    {
        if (is_null($blockchain)) {
            array_push($this->openAPINullablesSetToNull, 'blockchain');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('blockchain', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
